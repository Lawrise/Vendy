...
export function Flow() {
  const [activePov, setActivePov] = useState<Pov>("client");
  return (
    <div className="w-full flex justify-center mt-46  text-center mb-12 py-48 bg-primary clip-slant-both">
      ...
      <div className="mx-auto p-4 max-w-6xl w-full flex flex-col justify-center gap-y-20">
        ...
        <div className="flex justify-center gap-x-6">
          <Button
            variant={activePov === "client" ? "default" : "secondary"}
            onClick={() => setActivePov("client")}
          >
            Client Pov
          </Button>
          <Button
            variant={activePov === "vous" ? "default" : "secondary"}
